...
**Important:** When you delete files, you must use the `git add -A` command to make sure deletions are processed by Git, followed by the `git commit -m"<commit-message>"`.
